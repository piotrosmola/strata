  ...
  <section class="section marquee">
    ...
    <div class="section-bg">
      <div class="bg-image">
        <img src="assets/img/project07.jpg" alt="" />
      </div>
    </div>
    <!-- Content -->
    <div class="section-content">
      <h2><span>Everytime. Everywhere.</span></h2>
    </div>
  </section>
  ...
  <section class="section bg-white inverted">
    <!-- Container -->
    <div class="section-container container">
      <div class="container-inner mb-layout-sm">
        <h4 class="mb-layout-xs">Our Culture</h4>
        <div class="row gutters-lg align-items-center">
          <div class="col-md-6 mb-layout-xs mb-md-0">
            <!-- Media -->
            <div class="media">
              <img src="assets/img/our-culture.jpg" alt="" />
            </div>
          </div>
          <div class="col-md-6">
            <p>With communications changing faster than ever, our many combined decades of experience and adaptability really matter.</p>
            <p>
              We work as an extension of your team to manage every aspect of a project; strategy and planning, creative services, content, technical
              production, logistics, storage, and asset management.
            </p>
            <a href="#" class="btn btn-primary" data-mp>
              <span class="btn-outline" data-mp-item data-mp-scale="1.1"></span>
              <span class="btn-label">Who We Are</span>
