  ...
  <div class="section-container container">
    <div class="container-inner">
      ...
      <div class="section-content<?php if($image) echo ' has-images'; ?><?php if($center) echo ' fullwidth'; ?>">
        ...
        <?php if($center): ?>
        <div class="row<?php if($full_width) echo ' justify-content-center'; ?>">
          <div class="<?php echo ($full_width) ? 'col-lg-10' : 'col-md-9 ml-auto'; ?>">
            <?php endif; ?>
            <?php if($title): ?>
            <h1 class="<?php echo $title_size; ?>" data-split-chars data-animate="true"><?php echo $title; ?></h1>
            <?php endif; ?>
            <?php if($text): ?>
            <p class="lead border-<?php if($reversed && $align == 'right') echo 'right'; elseif(!$align) echo 'left'; else echo $align; ?>"><?php echo $text; ?>
            </p>
            <?php endif; ?>
